...
export const SEQ_ROUTE_CATALOG: SeqRouteCatalogEntry[] = [
    ...
    {
        path: "api/apikeys/{id}/metrics/{measurement}",
        method: "GET",
        permission: "Read",
        additional:
    ...
    {
        path: "api/apikeys/metrics/{measurement}",
        method: "GET",
        permission: "Project",
        additional: "",
        notes: "",
    ...
    {
        path: "api/appinstances/{id}/invoke",
        method: "POST",
        permission: "Write",
        additional:
    ...
    {
        path: "api/appinstances/{id}/metrics/{measurement}",
        method: "GET",
        permission: "Project",
        additional: "",
        notes: "",
    ...
    {
        path: "api/appinstances/resources",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/appinstances/template",
        method: "GET",
        permission: "System",
        additional: "",
        notes: "",
    ...
    {
        path: "api/backups/files/{filename}",
        method: "GET",
        permission: "System",
        additional: "",
        notes: "",
    ...
    {
        path: "api/backups/immediate",
        method: "POST",
        permission: "System",
        additional: "",
        notes: "Allows Cross-Site POSTs",
    },
    {
        path: "api/backups/resources",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/dashboards/query/template",
        method: "GET",
        permission: "Write",
        additional: "",
        notes: "",
    ...
    {
        path: "api/diagnostics/cluster/metrics",
        method: "GET",
        permission: "System",
        additional: "",
        notes: "",
    ...
    {
        path: "api/diagnostics/ingestion",
        method: "GET",
        permission: "System",
        additional: "",
        notes: "",
    ...
    {
        path: "api/diagnostics/metrics/{measurement}",
        method: "GET",
        permission: "Project",
        additional: "",
        notes: "",
    ...
    {
        path: "api/diagnostics/resources",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/diagnostics/usage-telemetry",
        method: "POST",
        permission: "Read",
        additional: "",
        notes: "",
    ...
    },
    {
        ...
        permission: "Public",
        additional:
            "If the RequireApiKeyForWritingEvents setting is enabled, requests must be authenticated and have the Ingest permission.",
        notes: "Allows Cross-Site POSTs",
    },
    {
    ...
    {
        path: "api/events/signal/{signalId}",
        method: "GET",
        permission: "Read",
        additional: "",
        notes: "Obsolete",
    ...
    {
        path: "api/events/tabulate/{signalId}",
        method: "GET",
        permission: "Read",
        additional: "",
        notes: "",
    ...
    {
        path: "api/expressionindexes/resources",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/expressionindexes/template",
        method: "GET",
        permission: "Write",
        additional: "",
        notes: "",
    ...
    {
        path: "api/expressions/resources",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/integrationtest/resources",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/retentionpolicies/resources",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/retentionpolicies/template",
        method: "GET",
        permission: "Project",
        additional: "",
        notes: "",
    ...
    {
        path: "api/runningtasks/resources",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/internal-error-reporting",
        method: "GET",
        permission: "System",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-authenticationprovider",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-checkforupdates",
        method: "GET",
        permission: "System",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-instancetitle",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-isactivedirectoryauthentication",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-isauthenticationenabled",
        method: "GET",
        permission: "Public",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-isusagetelemetryenabled",
        method: "GET",
        permission: "Read",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-minimumfreestoragespace",
        method: "GET",
        permission: "System",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-newusershowdashboardids",
        method: "GET",
    ...
    {
        path: "api/settings/setting-newusershowqueryids",
        method: "GET",
        permission: "Organization",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-newusershowsignalids",
        method: "GET",
        permission: "Organization",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-raweventmaximumcontentlength",
        method: "GET",
        permission: "System",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-rawpayloadmaximumcontentlength",
        method: "GET",
        permission: "System",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-requireapikeyforwritingevents",
        method: "GET",
        permission: "Project",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-searchdurationseconds",
        method: "GET",
        permission: "Read",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-servicenameexpression",
        method: "GET",
        permission: "Read",
        additional: "",
        notes: "",
    ...
    {
        path: "api/settings/setting-themestyles",
        method: "GET",
        permission: "System",
        additional: "",
        notes: "",
    ...
    {
        path: "api/users/{id}/searches",
        method: "DELETE",
        permission: "Write",
        additional: "Only the principal's own search history can be cleared.",
        notes: "",
    },
    {
        path: "api/users/{id}/searches",
        method: "GET",
        permission: "Read",
        additional: "Only the principal's own search history can be retrieved.",
        notes: "",
    },
    {
        path: "api/users/{id}/searches/update",
        method: "POST",
        permission: "Write",
        additional: "Only the principal's own search history can be updated.",
        notes: "",
    },
    {
        path: "api/users/{id}/unlinkauthenticationprovider",
        method: "POST",
        permission: "System",
        additional: "",
        notes: "",
    },
    {
        ...
        method: "GET",
        permission: "Public",
        additional: "Can only return logged-in user information.",
        notes: "",
    },
    {
    ...
    },
    {
        ...
        method: "GET",
        permission: "Public",
        additional: "The Windows identity must already be authenticated.",
        notes: "",
    },
    {
        path: "oidc/challenge",
